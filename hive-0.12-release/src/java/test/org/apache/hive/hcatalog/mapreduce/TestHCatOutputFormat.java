...
public class TestHCatOutputFormat extends TestCase {
  ...
  private static final String dbName = "houtTestDB";
  private static final String tblName = "houtTestTable";
  ...
  private void initTable() throws Exception {
    ...
    fields.add(new FieldSchema("colname", serdeConstants.STRING_TYPE_NAME, "test"));
    ...
    //sd.setBucketCols(new ArrayList<String>(2));k
    ...
    System.out.println(client.getTable(dbName, tblName));
